...
const home = () => {
  return (
    <div className=" relative grid h-full w-full grid-rows-[auto_auto] flex-col  items-end justify-center p-24 max-lap:p-8 max-lap:text-center tab:mt-16  lap:grid lap:grid-cols-2 ">
      ...
      <div className="relative z-[10] flex h-full items-end justify-center  max-lg:mt-36 max-tab:mt-24">
